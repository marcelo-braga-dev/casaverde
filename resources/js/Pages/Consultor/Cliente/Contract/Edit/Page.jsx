...
const Page = ({contract}) => {
    ...
    const client = contract?.client_profile;
    ...
    const {data, setData, processing, errors} = useForm({
        ...
        issued_at: toDateInput(contract?.issued_at),
    ...
    const submit = (e) => {
        ...
        router.post(route("consultor.cliente.contratos.update", contract.id), {...data, _method: "PUT"})
    };

    return (
        <Layout titlePage="Editar Contrato" menu="clientes" subMenu="contratos-index" backPage>
                ...
                <CardContent>
                    <Grid container spacing={3}>
                        <Grid size={{xs: 12, md: 4}}>
                            ...
                            <Typography>{contract?.contract_code ?? `#${contract?.id}`}</Typography>
                        </Grid>
