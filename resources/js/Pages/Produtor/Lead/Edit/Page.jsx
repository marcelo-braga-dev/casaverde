...
export default function Page({
    ...
    return (
        <Layout titlePage="Editar Lead de Produtor" menu="produtores">
            <Head title="Editar Lead de Produtor" />

            <Card>
                <CardContent>
                    <Typography variant="h6" marginBottom={3}>
                        Editar lead de produtor
                    </Typography>
                    ...
                    <form onSubmit={submit}>
                        <Grid container spacing={2}>
                            ...
                            <Grid size={{ xs: 12, md: 4 }}>
                                <TextField label="Taxa de redução" value={data.taxa_reducao} onChange={(e) => setData("taxa_reducao", e.target.value)} error={!!errors.taxa_reducao} helperText={errors.taxa_reducao} fullWidth />
                            </Grid>
                            ...
                            <Grid size={{ xs: 12, md: 4 }}>
                                <TextField label="Potência" value={data.potencia} onChange={(e) => setData("potencia", e.target.value)} error={!!errors.potencia} helperText={errors.potencia} fullWidth />
                            </Grid>
