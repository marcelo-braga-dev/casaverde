...
const Page = ({ clients = [], concessionarias = [] }) => {
    ...
    const submit = (e) => {
        ...
        post(route("admin.fatura-import-settings.store"));
    };

    const getClientLabel = (client) => {
        const nome = client?.nome || client?.razao_social || "Cliente";
    ...
    return (
        <Layout
            titlePage="Cadastro de Email do Cliente"
            menu="faturas"
            subMenu="fatura-import-settings"
            backPage
        >
                        ...
                        <Grid container spacing={3}>
                            ...
                            <Grid size={{ xs: 12, md: 6 }}>
                                <TextField
                                    ...
                                    helperText={errors.imap_password}
                                    type="password"
                                    required
                                    fullWidth
                                />
                            ...
                            <Grid size={{ xs: 12, md: 6 }}>
                                <TextField
                                    ...
                                    helperText={errors.pdf_password}
                                    type="password"
                                    fullWidth
                                />
                            </Grid>
